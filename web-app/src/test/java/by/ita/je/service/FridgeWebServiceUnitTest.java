...
class FridgeWebServiceUnitTest {
    ...
    void createFridgeDto() {
        String url = "http://nginx/business/fridge/create";
    ...
    @Test
    void readFridge() {
        String url = "http://nginx/business/fridge/read/1";
    ...
    void addKettleAndMulticooker() {
        String urlFridgeUpdate = "http://nginx/business/fridge/update?number=1";
        Integer number = 1;
    ...
    void findFridgeAndUpdateByConditional() {
        String urlFridgeUpdate = "http://nginx/business/fridge/update_conditional?number={number}&parameter={parameter}";
    ...
    @Test
    void deleteFridge() {
        String url = "http://nginx/business/fridge/delete/1";
